...
---
Если хотите, могу дополнить README более техническими секциями: пример структуры API, рекомендации по тестам MSW, шаблоны Pull Request, или подготовить badge'ы CI/coverage. Напишите, что добавить.
