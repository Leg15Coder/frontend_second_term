      ...
      <main className="flex-1 p-8">
        <div className="max-w-3xl mx-auto">
          <div className="glass-panel p-6 flex items-center gap-6">
            <div className="w-24 h-24 rounded-full bg-center bg-cover" style={{ backgroundImage: `url(${me?.photoURL ?? 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=300&q=80'})` }} />
