      ...
      <div className="container mx-auto relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            <button className="btn-magic flex items-center justify-center gap-2 group text-lg">
              <Rocket className="w-5 h-5" />
              Инвестировать в идею
              <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
            </button>
            <Link to="/" className="btn-outline-magic flex items-center justify-center gap-2 text-lg">
              <Play className="w-5 h-5" />
              Посмотреть демо
            </Link>
            <button className="glass-card px-6 py-4 flex items-center justify-center gap-2 text-muted-foreground hover:text-foreground transition-colors">
